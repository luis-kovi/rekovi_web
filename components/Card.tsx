...
export default function Card({ card }: CardProps) {
  ...
  if (isDisabledPhase) {
    ...
    return (
      <div className="kanban-card bg-gradient-to-br from-gray-50/90 to-gray-100/70 rounded-2xl shadow-md border border-gray-200/60 flex flex-col h-52 opacity-70 cursor-not-allowed backdrop-blur-sm relative overflow-hidden group">
        ...
        <div className="p-3 flex justify-between items-center bg-gradient-to-r from-gray-100/60 to-gray-50/80 rounded-t-2xl border-b border-gray-200/40 relative z-10">
        ...
        <div className="px-3 py-2 space-y-2.5 text-xs flex-1 relative z-10">
        ...
        <div className="p-3 flex items-center justify-center border-t border-gray-200/50 bg-gradient-to-r from-gray-50/60 to-white/80 rounded-b-2xl mt-auto relative z-10">
  ...
  return (
    <div className="kanban-card data-item bg-white/98 backdrop-blur-sm rounded-2xl shadow-md border border-gray-200/60 flex flex-col h-52 cursor-pointer hover:shadow-xl hover:border-gray-300/80 hover:bg-white hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
      ...
      <div className="p-3 flex justify-between items-center bg-gradient-to-r from-gray-50/60 to-white/80 rounded-t-2xl border-b border-gray-200/40 relative z-10">
        ...
        <span className={`text-xs font-bold px-3 py-1.5 rounded-full ${slaColor} backdrop-blur-sm`}>
          {card.slaText}
        </span>
      </div>
      <div className="px-3 py-2 space-y-2.5 text-xs flex-1 relative z-10">
      ...
      <div className="p-3 flex items-center justify-between border-t border-gray-200/40 bg-gradient-to-r from-gray-50/60 to-white/80 rounded-b-2xl mt-auto relative z-10 backdrop-blur-sm">
        <div className="flex items-center text-xs font-bold">
          <div className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-full shadow-sm ${
